...
var loc0470 = Location(mapID: 470, locationName: "App&Sim", bgImage: "", blocks: [ptb0470, ptb0471, ptb0472], actions: [actNext, act1000 ])
...
var loc1000 = Location(mapID: 1000, locationName: "Commons North Hall", owner: "Mr. Fitzer", bgImage: "commons", blocks: [ptb1000], actions: [act0470, act0100, act0110, act0120, act0130, act0140, act0002], sound: "fdfCafe" )
...
var loc2000 = Location(mapID: 2000, locationName: "Commons South Hall", owner: "Mr. Fitzer", bgImage: "commons", blocks: [ptb1000], actions: [act0150, act0160, act0170, act0180, act0190, act0002], sound: "fdfCafe" )
var ptb2000 = PTBlock( image: "fdfJHallLobby2", text: "Commons South Hall", actions: [], sound: "fdfCafe")




var loc0003 = Location(mapID: 3, locationName: "Nieve Dormitory", owner: "Mr. Fitzer", bgImage: "dorm", blocks: [dormLobby], actions: [act3000, act4000, act5000, act0001, act0002] , sound: "fdfDormMusic")
var act0003 = Action(type: .loadLocation, text: "Nieve Dormitory Lobby", goLocation: 3)

var loc3000 = Location(mapID: 3000, locationName: "Dorms 2st Floor Lobby", bgImage: "", blocks: [ptb3000], actions: [act0003], sound: "fdfElevator")
...
var loc4000 = Location(mapID: 4000, locationName: "Dorms 3rd Floor Lobby", bgImage: "", blocks: [ptb4000], actions: [act0260, act0270,act0220,act0280,act0290,act0300, act0310, act0003], sound: "fdfElevator")
var ptb4000 = PTBlock(image: "fdfDormFloor", text: "Welcome to Nieve Dorms 3rd Floor Lobby", actions: [], sound: "fdfElevator")

var loc5000 = Location(mapID: 5000, locationName: "Dorms 4th Floor Lobby", bgImage: "", blocks: [ptb5000], actions: [act0320, act0270,act0330,act0340,act0350,act0360, act0370, act0003], sound: "fdfElevator")
var ptb5000 = PTBlock(image: "fdfDormFloor", text: "Welcome to Nieve Dorms 4th Floor Lobby", actions: [], sound: "fdfElevator")



var loc7000 = Location(mapID: 7000, locationName: "Jerimiah Hall\n3rd Floor lobby", owner: "Fitzer", bgImage: "fdfJHallLobby", blocks: [itb7001], actions: [act0380, act0390, act0400, act0410, act0420, act0001], sound: "fdfElevator")
...
var loc6000 = Location(mapID: 6000, locationName: "Jerimiah Hall\n2nd Floor lobby", owner: "Fitzer", bgImage: "fdfJHallLobby", blocks: [itb6001], actions: [act0430, act0440, act0450, act0460, act0470, act0480, act0001], sound: "fdfElevator")
